        ...
        <DialogContent className="glass-card-ultra-light border-estate-primary/20 max-w-md">
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Input id="name" name="name" placeholder="Enter estate name" value={newEstate.name} onChange={handleNewEstateChange} className="glass-input" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="description">Description</Label>
              <Textarea id="description" name="description" placeholder="Enter estate description (optional)" value={newEstate.description} onChange={handleNewEstateChange} className="glass-input" />
            </div>
          </div>
          <DialogFooter>
