...
const Layout = ({
  ...
  return <div className="flex flex-col min-h-screen" style={theme === "dark" ? darkModeStyles : lightModeStyles}>
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <footer className="py-4 text-center text-xs text-white/70 light-mode:text-black/70 border-t border-white/10 light-mode:border-black/10">
          <span className="bg-white/[0.47]">© {new Date().getFullYear()} UGHORON. All rights reserved.</span>
        </footer>
      </div>
    </div>;
};
